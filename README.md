...
| :------------------------------------------------: | :----------------------------------------------------: | :----------------------------------------------: |
| ![Login Screen](https://github.com/NOMANMUNEER/AuthenticationwithFireBase/blob/main/Login.png?raw=true) | ![Sign Up Screen]([URL_TO_YOUR_SIGNUP_SCREENSHOT.png](https://github.com/NOMANMUNEER/AuthenticationwithFireBase/blob/main/CA.png)) | ![Home Screen](URL_TO_YOUR_HOME_SCREENSHOT.png) |
