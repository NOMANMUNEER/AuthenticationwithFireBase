...
| :------------------------------------------------: | :----------------------------------------------------: | :----------------------------------------------: |
| ) | ![Sign Up Screen](URL_TO_YOUR_SIGNUP_SCREENSHOT.png) | ![Home Screen]([URL_TO_YOUR_HOME_SCREENSHOT.png](https://github.com/NOMANMUNEER/AuthenticationwithFireBase/blob/main/CA.png)) |
